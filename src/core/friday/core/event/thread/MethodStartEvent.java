...
public class MethodStartEvent implements IThreadEvent{
	...
	public MethodStartEvent(String signature){
	...
	public MethodStartEvent(String signature, long systemTime, long cpuTime){
